...
@pytest.mark.parametrize(
    'exp_date,holder,number,cvv,status',[
        ...
        ("07-21","Test 3","4539578763621486","123",201),#succes
        ...
        ("07-21","Test 6","4539578763620000","124",400),#Credit Card is not valid
        ("07-21","Test 7","4539578763621486","14",400),#cvv has less tha 3 digits
        ("07-21","Test 8","4539578763621486","14681",400)#cvv has more than 4 digits
    ]
)
